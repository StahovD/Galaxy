...
let item_desc_text = document.querySelectorAll('.merch-item-descr')
let item_prices_text = document.querySelectorAll('.merch-item-price')
let item_prices = ['1000', '1000', '2500', '5000']
let item_desc = ['Тарілка з принтом Марса. Доступна в червоному та білому кольорах',
...
'Масштабна модель марсохода (ми купуємо їх у NASA)']
 for (let i=0; i< item_names.length; i+=1){
    item_desc_text[i].innerHTML = item_desc[i]
    item_prices_text[i].innerHTML = item_prices[i]
 }
